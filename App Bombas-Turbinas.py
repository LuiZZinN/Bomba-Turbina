...
# ==========================================
        ...
        sw_script = f"""' ==============================================================================
' EXPERIMENTAL SOLIDWORKS VBA MACRO - AUTOGENERATED
...
Sub main()
    ...
    ' Implementação conceitual dos pontos na API SW para revolução
    Part.SketchManager.CreateLine D1 / 2, b1 / 2, 0, D2 / 2, b2 / 2, 0
    Part.SketchManager.CreateLine D2 / 2, -b2 / 2, 0, D1 / 2, -b1 / 2, 0
    
    ' Revolução do cubo/Hub
    Part.FeatureManager.FeatureRevolve2 True, True, False, False, False, False, 0, 0, 2 * 3.14159, 0, False, False, 0.01, 0.01, 0, 0, 0, True, True, True
"""
